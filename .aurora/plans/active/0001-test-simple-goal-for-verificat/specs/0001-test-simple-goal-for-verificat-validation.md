# Validation Rules: Test Simple Goal For Verificat
...
- [ ] `specs/0001-test-simple-goal-for-verificat-planning.md` - Planning capability
- [ ] `specs/0001-test-simple-goal-for-verificat-commands.md` - Command schemas
- [ ] `specs/0001-test-simple-goal-for-verificat-validation.md` - Validation rules (this file)
- [ ] `specs/0001-test-simple-goal-for-verificat-schemas.md` - Data schemas
...
grep -c "\[x\]" .aurora/plans/active/0001-test-simple-goal-for-verificat/tasks.md
```
