# Validation Rules: Refactor Authentication Module
...
- [ ] `specs/0002-refactor-authentication-module-planning.md` - Planning capability
- [ ] `specs/0002-refactor-authentication-module-commands.md` - Command schemas
- [ ] `specs/0002-refactor-authentication-module-validation.md` - Validation rules (this file)
- [ ] `specs/0002-refactor-authentication-module-schemas.md` - Data schemas
...
grep -c "\[x\]" .aurora/plans/active/0002-refactor-authentication-module/tasks.md
```
