# Validation Rules: Quick Feature
...
- [ ] `specs/0001-quick-feature-planning.md` - Planning capability
- [ ] `specs/0001-quick-feature-commands.md` - Command schemas
- [ ] `specs/0001-quick-feature-validation.md` - Validation rules (this file)
- [ ] `specs/0001-quick-feature-schemas.md` - Data schemas
...
grep -c "\[x\]" .aurora/plans/active/0001-quick-feature/tasks.md
```
