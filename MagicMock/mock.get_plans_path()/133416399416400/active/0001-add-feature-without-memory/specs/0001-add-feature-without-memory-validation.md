# Validation Rules: Add Feature Without Memory
...
- [ ] `specs/0001-add-feature-without-memory-planning.md` - Planning capability
- [ ] `specs/0001-add-feature-without-memory-commands.md` - Command schemas
- [ ] `specs/0001-add-feature-without-memory-validation.md` - Validation rules (this file)
- [ ] `specs/0001-add-feature-without-memory-schemas.md` - Data schemas
...
grep -c "\[x\]" .aurora/plans/active/0001-add-feature-without-memory/tasks.md
```
