# Validation Rules: Implement Simple Feature
...
- [ ] `specs/0001-implement-simple-feature-planning.md` - Planning capability
- [ ] `specs/0001-implement-simple-feature-commands.md` - Command schemas
- [ ] `specs/0001-implement-simple-feature-validation.md` - Validation rules (this file)
- [ ] `specs/0001-implement-simple-feature-schemas.md` - Data schemas
...
grep -c "\[x\]" .aurora/plans/active/0001-implement-simple-feature/tasks.md
```
