# Validation Rules: Simple Feature
...
- [ ] `specs/0001-simple-feature-planning.md` - Planning capability
- [ ] `specs/0001-simple-feature-commands.md` - Command schemas
- [ ] `specs/0001-simple-feature-validation.md` - Validation rules (this file)
- [ ] `specs/0001-simple-feature-schemas.md` - Data schemas
...
grep -c "\[x\]" .aurora/plans/active/0001-simple-feature/tasks.md
```
