...
**After (v0.3.0+):**
```bash
# No config file for API keys - configuration moved to project-local
aur init  # Creates .aurora/config.json in project directory
```

**Impact:**
- Configuration is now project-local (`.aurora/config.json`)
