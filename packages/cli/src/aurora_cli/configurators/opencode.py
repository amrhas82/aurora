...
class OpenCodeConfigurator(BaseConfigurator):
    ...
    async def get_template_content(self, aurora_dir: str) -> str:
        ...
        Returns:
            Template content for OPENCODE.md
        """
        return f"""# Aurora Planning Instructions for OpenCode

These instructions enable OpenCode to work with Aurora's planning system.
