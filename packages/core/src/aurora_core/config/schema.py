        ...
        "proactive_health_checks": {
            ...
            "properties": {
                "enabled": {
                    "type": "boolean",
                    "default": True,
                    "description": "Enable proactive health monitoring during agent execution",
                },
                "check_interval": {
                    "type": "number",
                    "minimum": 0.1,
                ...
                "no_output_threshold": {
                    ...
                    "maximum": 300.0,
                    "default": 15.0,
                    "description": "Seconds of no output before marking agent as stalled",
                },
                "failure_threshold": {
                    "type": "integer",
                    "minimum": 1,
                    "maximum": 10,
                    "default": 3,
                    "description": "Number of failed health checks before termination",
                },
            },
            "additionalProperties": False,
            "description": "Proactive health monitoring configuration for agent execution",
        },
        "early_detection": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean",
                    "default": True,
                    "description": "Enable early failure detection for agent execution",
                },
                "check_interval": {
                    "type": "number",
                    "minimum": 0.1,
                    "maximum": 60.0,
                    "default": 2.0,
                    "description": "Interval between early detection checks in seconds",
                },
                "stall_threshold": {
                    "type": "number",
                    "minimum": 1.0,
                    "maximum": 300.0,
                    "default": 15.0,
                    "description": "Seconds without progress before marking as stalled",
                },
                "min_output_bytes": {
                    "type": "integer",
                    "minimum": 0,
                    "maximum": 10000,
                    "default": 100,
                    "description": "Minimum bytes of output to consider progress",
                },
                "stderr_pattern_check": {
                    "type": "boolean",
                    "default": True,
                    "description": "Check stderr for known error patterns",
                },
                "memory_limit_mb": {
                    "type": ["integer", "null"],
                    "minimum": 100,
                    "maximum": 32000,
                    "default": None,
                    "description": "Memory limit in MB (null for no limit)",
                },
            },
            "additionalProperties": False,
