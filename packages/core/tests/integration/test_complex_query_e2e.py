...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent.parent / "cli" / "tests" / "integration"))
from test_e2e_framework import E2ETestFramework, MockAgent, MockLLMResponse
