...
__all__ = ["record_pattern", "RecordResult", "SummaryRecord", "record_pattern_lightweight"]
...
def record_pattern(
    ...
    .. deprecated:: 0.7.0
        Use :func:`record_pattern_lightweight` instead.
    ...
    warnings.warn(
        "record_pattern is deprecated and will be removed in version 1.0.0. "
        "Use record_pattern_lightweight instead.",
        DeprecationWarning,
        stacklevel=2,
    )
