...
TEST_CORPUS = [
    ...
    (
        ...
        "medium",
        "analysis",
        "Requires profiling understanding",
    ),
    ...
    (
        ...
        "medium",
        "edit",
        "Multiple locations, judgment needed",
    ),
    ...
    (
        ...
        "complex",
        "feature",
        "Major feature, multiple components",
    ),
    ...
    (
        "implement caching across all api endpoints",
        "complex",
        "feature",
    ...
    (
        "implement new auth without breaking existing sessions",
        "complex",
        "feature",
        "Feature + constraint",
    ),
    (
        "refactor the api while maintaining backwards compatibility",
        "complex",
        "refactor",
        "Refactor + constraint",
    ),
    (
        "migrate to new framework ensuring all tests still pass",
        "complex",
        "migration",
        "Migration + constraint",
    ),
    (
        "add feature flags while keeping deployment simple",
        "complex",
        "feature",
        "Feature + constraint",
    ),
    (
        "optimize database queries without changing the schema",
        "complex",
        "optimization",
    ...
    (
        "implement authentication on frontend and backend with database storage",
        "complex",
        "feature",
        "Multi-layer",
    ),
    (
        "add real-time updates using websockets with proper error handling and reconnection",
        "complex",
        "feature",
        "Multiple concerns",
    ),
    (
        "create api endpoints with authentication, rate limiting, and caching",
        "complex",
        "feature",
        "Multiple features",
    ),
    (
        "implement ci/cd pipeline with testing, staging, and production deployments",
        "complex",
        "devops",
        "Multi-stage pipeline",
    ),
    (
        "build a monitoring system with logging, metrics, and alerting",
        "complex",
        "feature",
        "Multiple components",
    ),
    ...
    (
        "first analyze the current architecture, then design improvements, implement them, and write tests",
        "complex",
        "workflow",
        "Multi-phase project",
    ),
    (
        "1. review all api endpoints 2. identify security issues 3. fix them 4. add tests",
        "complex",
        "workflow",
        "Numbered complex tasks",
    ),
    (
        "implement the feature, add tests, update documentation, and create a migration guide",
        "complex",
        "workflow",
        "Multi-deliverable",
    ),
    (
        "refactor to clean architecture: separate concerns, add interfaces, implement dependency injection",
        "complex",
        "refactor",
        "Multi-part architectural change",
    ),
    # ==================== EDGE CASES ====================
    # Short but complex
    ...
    # Long but simple
    (
        "can you please show me the contents of the readme file in the root directory",
        "simple",
        "edge",
        "Verbose but single action",
    ),
    (
        "i would like you to tell me what version of python is being used in this project",
        "simple",
        "edge",
        "Verbose but lookup",
    ),
    ...
    (
        "how should we handle errors across the application",
        "complex",
        "edge",
        "Question implies design decision",
    ),
    (
    ...
    # Real-world examples
    (
        "help me understand why this regex isn't matching",
        "medium",
        "real",
        "Debug with explanation",
    ),
    (
        "i'm getting a 500 error on the /api/users endpoint, can you help",
        "medium",
        "real",
        "Debug scenario",
    ),
